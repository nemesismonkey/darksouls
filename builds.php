...
<script src="js/tt.standalone.js<?php echo $ta['ttstandalone']; ?>"></script>
<script src="js/alphanum.js<?php echo $ta['alphanum']; ?>"></script>
<script src="js/builds.js<?php echo $ta['builds']; ?>"></script>
